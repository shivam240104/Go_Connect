...
import { createPost, deletePost, getAllComments, getAllPosts, increamentPostLike, postComment } from '@/config/redux/action/postAction';
        ...
        <UserLayout>
            ...
            <DashboardLayout>
              <div className={styles.scrollComponent}>
                ...
                <div className={styles.createPostConatainer}>

                  <img  className={styles.userProfile} 
                  src= {`${BaseURL}/${authState.user.userId.profilePicture}`} alt="" />

                  <textarea onChange={(e) => setPostContent(e.target.value)} value={postContent}
                   className= {styles.textarea} placeholder={"What's in your mind ?"} name="" id=""></textarea>
                    ...
                    <div className={styles.singleCard_profileContainer} >
                     <img 
                      ...
                      <div className={styles.optionsContainer}>
                        <div onClick={async() =>{
                          await dispath(increamentPostLike({post_id :post._id}))
                          dispath(getAllPosts())
                        }}
                          ...
                          return (
                            <div className={styles.singleComment} key={PostComment._id}>
                              <div className={styles.singleComment_profileContainer}>
                                <img src={`${BaseURL}/${PostComment.userId.profilePicture}`} alt="" />
                                <div >
